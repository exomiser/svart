...
public record DefaultSequenceVariant(Contig contig, String id, Strand strand, Coordinates coordinates, String ref, String alt, VariantType variantType) implements GenomicVariant, Comparable<GenomicVariant> {
