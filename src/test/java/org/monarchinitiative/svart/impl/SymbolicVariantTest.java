...
class SymbolicVariantTest {
    ...
    @Test
    void shouldBeBreakend() {
        GenomicVariant instance = GenomicVariant.of(chr1, "", Strand.POSITIVE, CoordinateSystem.ONE_BASED, 1, 1, "A", "<BND>", 100);
    ...
    void canCreateSymbolicBreakendAllele() {
        GenomicVariant instance = SymbolicVariant.of(chr1, "bnd_u", Strand.POSITIVE, CoordinateSystem.ONE_BASED, 1, 1, "A", "G]2:123456]", 0, "bnd_v", "event_1");
        assertThat(instance.contig(), equalTo(chr1));
        assertThat(instance.strand(), equalTo(Strand.POSITIVE));
        assertThat(instance.start(), equalTo(1));
        assertThat(instance.end(), equalTo(1));
