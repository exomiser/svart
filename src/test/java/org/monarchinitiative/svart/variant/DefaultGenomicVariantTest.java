...
class DefaultGenomicVariantTest {
    private final Contig chr1 = TestContig.of(1, 1000);

    @Nested
    class NonSymbolicTests {
        ...
        void snvZeroBased() {
            ...
            //  static Duration between(Temporal startInclusive, Temporal endExclusive) specifies '0-based' coordinates
    ...
    @Nested
    class SymbolicGenomicVariantTests {
        @Test
