...
class DefaultGenomicAssemblyTest {
    ...
    void contigByName_unknown(String name) {
    ...
    void contigByName_chr1(String name) {
    ...
    void contigByName_chrM(String name) {
    ...
    void contigByName_HSCHR17_1_CTG5(String name) {
    ...
    @Test
    void doesNotContainContigUnknown() {
    ...
    @Test
    void does_not_contain_chr1_wrong_assembly() {
    ...
    @Test
    void throwsExceptionWithDuplicatedIds() {
    ...
    @Test
    void throwsExceptionWithNonSequentialIds() {
        Contig one = TestContig.of(1, 249250621);
    ...
    @Test
    void throwsExceptionWithNonUnknownZeroId() {
    ...
    @Test
    void doesNotIncludeAssignedMoleculeNamesForNonAssembledMolecules() {
