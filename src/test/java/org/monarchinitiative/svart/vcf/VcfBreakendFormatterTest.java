...
class VcfBreakendFormatterTest {
    ...
    void makeAltVcfField(Strand leftStrand, String leftChr, int leftStart, int leftEnd,
        ...
        MatcherAssert.assertThat(VcfBreakendFormatter.makeRefVcfField(variant), equalTo(left.strand() == Strand.POSITIVE ? ref : NucleotideSeq.reverseComplement(ref)));
        assertThat(VcfBreakendFormatter.makeAltVcfField(variant), equalTo(expected));
    }

    GenomicBreakend makeBreakend(Strand strand, String chr, int start, int end, GenomicAssembly assembly) {
