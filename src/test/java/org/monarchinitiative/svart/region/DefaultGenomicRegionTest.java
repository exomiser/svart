...
import org.monarchinitiative.svart.InvalidCoordinatesException;
...
class DefaultGenomicRegionTest {
    ...
    void singleOrEmptyBase(CoordinateSystem inputCoords, int inputStart, int inputEnd,
    ...
    void toOppositeStrandAndBackAgain(Strand inputStrand, CoordinateSystem inputCoords, int inputStart, int inputEnd,
                                 Strand exptStrand, CoordinateSystem exptCoords, int exptStart, int exptEnd) {
    ...
    void emptyRegionUnknownChromosomeToOppositeStrand(Strand inputStrand, CoordinateSystem inputCoords, int inputStart, int inputEnd,
                                                             Strand exptStrand, CoordinateSystem exptCoords, int exptStart, int exptEnd) {
