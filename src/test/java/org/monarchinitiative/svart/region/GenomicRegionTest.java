...
class GenomicRegionTest {
    ...
    void containsPosition(CoordinateSystem coordinateSystem, int start, int end,
                                 int position,
                                 boolean expected) {
    ...
    void GenomigRegionOverlapsOther(Strand thisStrand, CoordinateSystem thisCoordinateSystem, int thisStart, int thisEnd,
    ...
    void zeroBasedRegionContainsRegion(Strand thisStrand, CoordinateSystem thisCoordinateSystem, int thisStart, int thisEnd,
                                              Strand otherStrand, CoordinateSystem otherCoordinateSystem, int otherStart, int otherEnd,
                                              boolean expected) {
        GenomicRegion region = GenomicRegion.of(chr1, thisStrand, thisCoordinateSystem, thisStart, thisEnd);
        GenomicRegion other = GenomicRegion.of(chr1, otherStrand, otherCoordinateSystem, otherStart, otherEnd);
    ...
    void oneBasedRegionContainsRegion(CoordinateSystem thisCoordinateSystem, int thisStart, int thisEnd,
    ...
    @Test
    void containsRegion_otherContig() {
    ...
    void distanceTo(Strand xStrand, int xStart, int xEnd,
    ...
    void withStrand_emptyRegion(Strand strand, CoordinateSystem coordinateSystem, int start, int end, int expectedStart, int expectedEnd) {
    ...
    void withStrand_strandConversions(Strand source, CoordinateSystem coordinateSystem, int start, int end,
                                             Strand target,
    ...
    void withPadding_singlePadding(CoordinateSystem coordinateSystem,
                                          int start, int end,
                                          int padding,
    ...
    void testWithPadding_upDownPadding(CoordinateSystem coordinateSystem,
                                              int start, int end,
    ...
    void testStartPositionWithCoordinateSystem(CoordinateSystem coordinateSystem, int startPos, int endPos, CoordinateSystem targetCoordinateSystem, int expectedStart) {
    ...
    void testEndWithCoordinateSystem(CoordinateSystem coordinateSystem, int startPos, int endPos,
    ...
    void testStartOnStrandWithCoordinateSystem(Strand strand, CoordinateSystem coordinateSystem, int startPos, int endPos, Strand targetStrand, CoordinateSystem targetCoordinateSystem, int expectedStart) {
    ...
    void testEndOnStrandWithCoordinateSystem(Strand strand, CoordinateSystem coordinateSystem, int startPos, int endPos, Strand targetStrand, CoordinateSystem targetCoordinateSystem, int expectedEnd) {
        GenomicRegion region = GenomicRegion.of(chr1, strand, coordinateSystem, startPos, endPos);
    ...
    void testWithCoordinateSystem(CoordinateSystem source, int start, int end,
    ...
    void testOverlapLength(Strand thisStrand, CoordinateSystem thisCoordinateSystem, int thisStart, int thisEnd,
                                  Strand otherStrand, CoordinateSystem otherCoordinateSystem, int otherStart, int otherEnd,
                                  int expected) {
        GenomicRegion region = GenomicRegion.of(chr1, thisStrand, thisCoordinateSystem, thisStart, thisEnd);
        GenomicRegion other = GenomicRegion.of(chr1, otherStrand, otherCoordinateSystem, otherStart, otherEnd);
    ...
    @Test
    void testImpreciseRegionMinMax() {
    ...
    private static class TestGenomicRegion extends BaseGenomicRegion<TestGenomicRegion> {
        ...
        TestGenomicRegion(Contig contig, Strand strand, Coordinates coordinates) {
            super(contig, strand, coordinates);
        }

        TestGenomicRegion(Builder builder) {
            super(builder);
        }
